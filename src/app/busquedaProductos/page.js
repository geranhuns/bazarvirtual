    ...
    <div className="flex flex-col    mx-auto  lg:max-w-screen-xl overflow-auto   ">
      <div className="flex flex-col w-full md:mx-auto  lg:max-w-screen-xl ">
        <div className="flex ">
          ...
          <h2 className="ml-4 pt-6 text-xl self-start  md:pl-0">{`"${search}"`}</h2>
          <h2 className="ml-4 pt-6 text-xl self-start  md:pl-0">
            en la categoría:
          </h2>
          <h2 className="ml-4 pt-6 text-xl self-start  md:pl-0">{`"${category}"`}</h2>
        </div>
