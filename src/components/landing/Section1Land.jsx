        ...
        <section className="relative bg-landing1 bg-cover bg-center min-h-screen  w-full">
            <div className="  absolute inset-0 bg-fill-landing1 flex flex-col items-center justify-center ">
                <div className=" w-9/12 h-64 ">
                    ...
                    <button className="bg-raw-sienna-500 rounded-3xl h-16 w-4/12 mt-4 text-raw-sienna-50 text-base font-semibold leading-custom2 tracking-wide hover:bg-white transition duration-500  hover:text-color-btnUnete ">Explorar mas</button>
                </div>
            </div>
      </section>
        </>
