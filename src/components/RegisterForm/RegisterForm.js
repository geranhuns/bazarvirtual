      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className=" flex flex-col gap-3  lg:w-96 mb-3  ">
          <div className="flex flex-col gap-1">
            ...
            />
            {errors.userName && <label className="text-red-700  text-xs">{errors.userName.message}</label>}
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              className={`border rounded-lg p-4 ${errors.email ? 'border-red-500' : 'border-gray-300'}`} 
              type="text"
              placeholder=""
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              className={` border rounded-lg p-4 ${errors.password ? 'border-red-500' : 'border-gray-300'} `}
              type="password"
              placeholder=""
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              className={`border rounded-lg p-4 ${errors.passwordComparation ? 'border-red-500' : 'border-gray-300'} `} 
              type="password"
              placeholder=""
              {...register("passwordComparation", { required: "Este campo es requerido", minLength: { value: 8, message: "El password debe tener al menos 8 caracteres" } })} 
            />
            {errors.passwordComparation && <label className="text-red-700  text-xs">{errors.passwordComparation.message}</label>}
          </div>
          <button type="submit" className="bg-raw-sienna-500 text-raw-sienna-50 flex items-center justify-center p-1 rounded-lg text-lg  font-medium h-9">Crear cuenta</button>
