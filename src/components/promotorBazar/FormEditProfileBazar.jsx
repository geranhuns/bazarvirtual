  ...
  return (
    <>
      <div className="fixed inset-0 z-50 bg-gray-600/80 w-full h-dvh lg:max-w-screen-xl overflow-auto mx-auto backdrop-blur-md mt-14 px-1 ">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className=" bg-customBlue w-7/12 h-5/6 rounded-xl   mx-auto px-4 flex flex-col items-center max-md:w-10/12 max-sm:w-full mt-10"  >
          <button className="bg-raw-sienna-500 w-10 h-10 flex justify-center items-center self-start mt-5 rounded-full " onClick={() => setActive(!active)} >X</button>
